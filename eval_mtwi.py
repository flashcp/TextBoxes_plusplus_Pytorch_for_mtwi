...
from data import MTWIAnnotationTransform, MTWIDetection, BaseTransform
...
parser.add_argument('--trained_model',
                    default='weights/mtwi_1.pth', type=str,
...
parser.add_argument('--voc_root', default='F:\dataset\mtwi_simple',
...
if __name__ == '__main__':
    ...
    # load data
    dataset = MTWIDetection(args.voc_root,
                           BaseTransform(384),
                           MTWIAnnotationTransform())
    if args.cuda:
        net = net.cuda()
